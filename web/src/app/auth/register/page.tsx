...
export const metadata: Metadata = {
  title: 'Registro | ShortCat Platform',
  description: 'Regístrate en ShortCat Platform',
};
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-secondary p-4 sm:p-6">
      <div className="w-full max-w-md space-y-6 sm:space-y-8">
        <div className="flex flex-col items-center">
          ...
          <p className="text-secondary-foreground mt-2 text-base">Marketplace de construcción y ferretería</p>
        </div>
